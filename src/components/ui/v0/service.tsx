...
const services = [
  {
    ...
    description:
      "Crafting visual systems that speak louder than words. We build brands that resonate and endure.",
  },
  {
    icon: <Smartphone className="w-8 h-8 text-purple-400" />,
    title: "Digital Product",
    description:
      "User-centric interfaces designed for clarity and delight. From mobile apps to complex dashboards.",
  },
  {
    icon: <Code2 className="w-8 h-8 text-indigo-400" />,
    title: "Development",
    description:
      "Clean, scalable code that powers your vision. We build robust solutions using cutting-edge tech.",
  },
  {
    icon: <Rocket className="w-8 h-8 text-pink-400" />,
    title: "Growth Strategy",
    description:
      "Data-driven insights to scale your digital presence. We help you reach and engage your audience.",
  },
];
